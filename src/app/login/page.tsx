...
import { UserCheck, KeyRound, ArrowRight, Eye, EyeOff } from 'lucide-react';
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder="••••••••"
                  required
                  className="bg-black/40 border-white/20 text-white placeholder-slate-400 focus-visible:ring-[#0F766E] pr-10"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((prev) => !prev)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-white transition-colors p-1 rounded-md focus:outline-none focus:ring-1 focus:ring-teal-500 cursor-pointer"
